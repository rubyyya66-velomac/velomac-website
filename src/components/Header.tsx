...
export function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-metal-200 bg-white backdrop-blur-md">
      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-3 px-5 py-3 sm:px-6 sm:py-4 lg:px-8 xl:flex-row xl:items-center xl:justify-between xl:gap-6">
